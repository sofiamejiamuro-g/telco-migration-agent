NATIVE_TRANSFER_TARGETS = {"RootAgent", "RootAgent"}

from typing import Optional

def before_model_callback(callback_context: CallbackContext, llm_request: LlmRequest) -> Optional[LlmResponse]:
    # Phase 2: State Normalization for Language and Auth Status
    if callback_context and hasattr(callback_context, "variables") and callback_context.variables is not None:
        ...
        if not callback_context.variables.get("auth_status"):
            callback_context.variables["auth_status"] = "UNAUTHENTICATED"
